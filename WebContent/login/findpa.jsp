...
<body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%" align="center">
    ...
    <div class="card align-middle" style="width:25rem;">
        <div class="card-title" style="margin-top:30px;">
            ...
            <h2 class="card-title" style="color:#f58b34;"><img src="img/logo.png" /></h2>
        </div>

        <div class="card-body">
            <form action="findpwserver.jsp" class="form-signin" method="POST">
        ...
        <div class="links">
        <form action="idfinds.jsp" method="post">
